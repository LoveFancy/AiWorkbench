...
PARTITION BY RANGE (TO_DAYS(`created_at`)) (
    ...
    PARTITION p_202607 VALUES LESS THAN (TO_DAYS('2026-09-01')),
    PARTITION p_202607 VALUES LESS THAN (TO_DAYS('2026-10-01')),
    PARTITION p_202607 VALUES LESS THAN (TO_DAYS('2026-11-01')),
    PARTITION p_202607 VALUES LESS THAN (TO_DAYS('2026-12-01'))
);
