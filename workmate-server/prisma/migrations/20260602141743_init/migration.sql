...
-- AddForeignKey
ALTER TABLE `upgrade_whitelist` ADD CONSTRAINT `upgrade_whitelist_source_strategy_id_fkey` FOREIGN KEY (`source_strategy_id`) REFERENCES `upgrade_strategies`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `upgrade_strategy_stages` ADD CONSTRAINT `upgrade_strategy_stages_strategy_id_fkey` FOREIGN KEY (`strategy_id`) REFERENCES `upgrade_strategies`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `upgrade_strategy_stage_rules` ADD CONSTRAINT `upgrade_strategy_stage_rules_stage_id_fkey` FOREIGN KEY (`stage_id`) REFERENCES `upgrade_strategy_stages`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
