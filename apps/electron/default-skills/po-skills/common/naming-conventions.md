...
- 正式需求文件统一放在 `newreq/<REQID>/1.产品设计/` 目录下。
- 正式需求图片放在 `newreq/<REQID>/1.产品设计/images/`。
- 参考资料及其图片放在 `newreq/<REQID>/references/` 和 `newreq/<REQID>/references/images/`。
...
- 引用参考资料图片时写成 `../references/images/<文件名>`。
