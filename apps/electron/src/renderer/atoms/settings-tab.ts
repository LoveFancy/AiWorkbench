...
export type SettingsTab = 'general' | 'channels' | 'appearance' | 'about' | 'agent' | 'plugins' | 'prompts' | 'tools' | 'usage-log' | 'system-log' | 'bots' | 'local-api' | 'tutorial' | 'shortcuts' | 'voice-input' | 'migration'
